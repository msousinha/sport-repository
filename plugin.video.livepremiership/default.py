...
baseurl         = 'http://pastebin.com/raw/05steBGf'
...
messagetext     = 'http://pastebin.com/raw/feTN9nxr'
livematches     = 'http://pastebin.com/raw/5C8FR51q'
...
def GetMenu():
        ...
        url = baseurl		
        addDir('[B][COLOR gold]S[/COLOR][COLOR white]earch[/COLOR][/B] [B][COLOR gold]L[/COLOR][COLOR white]ive Premiership[/COLOR][/B]',url,5,searchicon,fanarts)
...
def GetContent(name,url,iconimage,fanart):
        ...
        if url == "http://pastebin.com/raw/5C8FR51q":
            message=open_url2("http://pastebin.com/raw/R9PqPytC")
...
def SEARCH():
	keyb = xbmc.Keyboard('', '[COLOR gold]S[/COLOR][COLOR white]earch[/COLOR] [COLOR gold]L[/COLOR][COLOR white]ive Premiership[/COLOR]')
	keyb.doModal()
	if (keyb.isConfirmed()):
